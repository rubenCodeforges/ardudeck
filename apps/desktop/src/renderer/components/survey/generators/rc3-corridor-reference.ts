/**
 * FROZEN COPY of the corridor generator at v0.1.2-rc3 (fd746ae).
 *
 * Reference for corridor-rc3-parity.test.ts only: nothing ships against this.
 * Do not fix or extend it. If the parity test fails, either the change to the
 * live generator was deliberate (update the test and say why) or it is a
 * regression against what pilots are flying.
 */
/**
