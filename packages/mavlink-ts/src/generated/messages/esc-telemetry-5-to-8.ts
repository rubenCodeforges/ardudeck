 ...
 * CRC Extra: 133
 */
export interface EscTelemetry5To8 {
  /** Temperature. (degC) */
  temperature: number[];
  /** Voltage. (cV) */
  voltage: number[];
...
export const ESC_TELEMETRY_5_TO_8_ID = 11031;
export const ESC_TELEMETRY_5_TO_8_CRC_EXTRA = 133;
export const ESC_TELEMETRY_5_TO_8_MIN_LENGTH = 44;
export const ESC_TELEMETRY_5_TO_8_MAX_LENGTH = 44;

export function serializeEscTelemetry5To8(msg: EscTelemetry5To8): Uint8Array {
...
export function deserializeEscTelemetry5To8(payload: Uint8Array): EscTelemetry5To8 {
