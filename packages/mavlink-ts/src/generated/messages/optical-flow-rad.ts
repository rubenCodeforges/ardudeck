...
export interface OpticalFlowRad {
  ...
  /** Flow around X axis (Sensor RH rotation about the X axis induces a positive flow. Sensor linear motion along the positive Y axis induces a negative flow.) (rad) */
  integratedX: number;
  /** Flow around Y axis (Sensor RH rotation about the Y axis induces a positive flow. Sensor linear motion along the positive X axis induces a positive flow.) (rad) */
  integratedY: number;
...
export const OPTICAL_FLOW_RAD_ID = 106;
export const OPTICAL_FLOW_RAD_CRC_EXTRA = 138;
export const OPTICAL_FLOW_RAD_MIN_LENGTH = 44;
export const OPTICAL_FLOW_RAD_MAX_LENGTH = 44;

export function serializeOpticalFlowRad(msg: OpticalFlowRad): Uint8Array {
...
export function deserializeOpticalFlowRad(payload: Uint8Array): OpticalFlowRad {
