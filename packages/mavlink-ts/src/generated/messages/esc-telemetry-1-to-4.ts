 ...
 * CRC Extra: 144
 */
export interface EscTelemetry1To4 {
  /** Temperature. (degC) */
  temperature: number[];
  /** Voltage. (cV) */
  voltage: number[];
...
export const ESC_TELEMETRY_1_TO_4_ID = 11030;
export const ESC_TELEMETRY_1_TO_4_CRC_EXTRA = 144;
export const ESC_TELEMETRY_1_TO_4_MIN_LENGTH = 44;
export const ESC_TELEMETRY_1_TO_4_MAX_LENGTH = 44;

export function serializeEscTelemetry1To4(msg: EscTelemetry1To4): Uint8Array {
...
export function deserializeEscTelemetry1To4(payload: Uint8Array): EscTelemetry1To4 {
